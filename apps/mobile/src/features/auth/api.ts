import { AuthRequestError, graphqlRequest } from '@/src/features/auth/graphql-client';
import { LOGIN_MUTATION, REGISTER_MUTATION } from '@/src/features/auth/operations';
import type { AuthPayload, AuthUser } from '@/src/features/auth/types';
