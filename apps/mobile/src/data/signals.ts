...
export interface ReasoningStep {
  text: string;
  concept?: string; // concept id from data/lessons.ts
}
...
export const signals: Signal[] = [
  {
    ...
    thesis:
      'Bitcoin is holding a higher low while momentum quietly turns up — a bullish divergence at a level buyers have defended twice before.',
    reasoning: [
      {
      ...
      {
        text: 'RSI (14) made a higher low while price made a lower low: bullish divergence, which precedes reversal on this pair 63% of the time.',
    ...
    indicators: ['RSI 14', 'EMA 50/200', 'Funding', 'Volume'],
    entry: 68150,
    target: 71400,
    stop: 66550,
  ...
  },
  {
    ...
    reasoning: [
      {
        text: "Ten sessions of contracting range (a 'volatility squeeze') right below resistance — coils resolve in the trend direction ~68% of the time.",
    ...
    indicators: ['ATR squeeze', 'Volume', 'EMA 21'],
    entry: 129.4,
    target: 138.0,
    stop: 124.9,
  ...
  },
  {
    ...
    indicators: ['RSI 14', 'Supply zone', 'ETH/BTC'],
    entry: 3896,
    target: 3712,
    stop: 3968,
  ...
  },
  {
    ...
    reasoning: [
      {
        text: 'The bounce from 1.0780 lost momentum exactly at the 200-EMA — a level that rejected price 5 of the last 6 touches.',
        concept: 'ema',
      },
  ...
  },
  {
    ...
    reasoning: [
      ...
      {
        text: "The retest held old resistance as new support (a 'flip'), the highest-probability continuation entry.",
        concept: 'support-resistance',
      },
    ],
