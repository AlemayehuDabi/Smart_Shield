...
func (ec *executionContext) _Query_me(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOAuthUser2ᚖgithubᚗcomᚋAlemayehuDabiᚋSmart_SheildᚋservicesᚋtradingᚑengineᚋinternalᚋgraphqlᚋmodelᚐAuthUser,
		true,
		false,
	)
}
...
func (ec *executionContext) marshalOAuthUser2ᚖgithubᚗcomᚋAlemayehuDabiᚋSmart_SheildᚋservicesᚋtradingᚑengineᚋinternalᚋgraphqlᚋmodelᚐAuthUser(ctx context.Context, sel ast.SelectionSet, v *model.AuthUser) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._AuthUser(ctx, sel, v)
